...
class WriteExifActivity : Activity() {
    ...
    fun apply(path: String, filename: String, dateToSet: Date): String {
        ...
        try {
            //If the image had been changed before with oNbeat, just copying the file to DCIM/Changed/ won't create a new image
            ...
            //If the image had not been changed before with oNbeat, just take the DCIM/Changed + original filename as new path
